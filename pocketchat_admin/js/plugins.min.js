...
$(function () {
    ...
    $(".menu-sidebar-collapse").sideNav({menuWidth: 240, edge: "left", menuOut: false});
    $(".chat-collapse").sideNav({menuWidth: 300, edge: "right"});
    $(".datepicker").pickadate({selectMonths: true, selectYears: 15});
    $("select").not(".disabled").material_select();
    var leftnav = $(".page-topbar").height();
    var leftnavHeight = window.innerHeight - leftnav;
    if (!$("#slide-out.leftside-navigation").hasClass("native-scroll")) {
        $(".leftside-navigation").perfectScrollbar({suppressScrollX: true})
    }
    var righttnav = $("#chat-out").height();
    $(".rightside-navigation").perfectScrollbar({suppressScrollX: true});
