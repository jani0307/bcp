...
include "db.php";
			...
			<div class="text-inner-banner-one pos-r">
				...
				<div class="container">
					<p>About Us	</p>
					<h2 class="pt-30 pb-15" style="text-transform: none;">Blogs</h2>
...
$sql='SELECT * FROM bcp_blog LIMIT ' . $this_page_first . ',' .  $results_per_page;
$result = mysqli_query($con, $sql);
...
?>
						<div class="col-lg-6">
							<div class="blog-post-block-two mb-75 md-mb-60">
								<div class="img-holder"><img height="350px" width="570px" src="hitler_admin/upload/blog-image/<?php echo$row['img']; ?> " alt=""></div>
								<div class="post">
									<ul class="post-info">
										<li>Add By : <?php echo$row['add_by']; ?></li>
										<!-- li><a><?php echo$row['date']; ?></a></li -->
									</ul>
									<h4><a href="blog-details.php?name=<?php echo$name; ?>"><?php echo $row['title']; ?></a></h4>
									<p> <?php echo $row['title']; ?>...</p>
									<a href="blog-details.php?name=<?php echo$name; ?>" class="read-more inline-button-one">Continue Reading</a>
								</div> <!-- /.post -->
