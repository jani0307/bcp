...
include "header.php";
			...
			<div class="text-inner-banner-one pos-r">
				...
				<div class="container">
					...
					<h3 class="pt-15">Why Choose Us</h3>
				</div>
...
<!-- 
			...
			============================================== 
			-->
			<div class="intro-text-block pos-r" style="background-color: #f2f2f2;"> 
				<div class="container">
					<div class="row align-items-center">
							<div class="col-lg-6 order-lg-first">
							<div class="icon md-mt-40">
								<img src="images/home/22.jpg">
							</div>
						</div>
						<div class="col-lg-6 order-lg-last">
							<h5 style="font-size: 20px"><span>BlackCrescent Capital Management LP is an alternative investment management firm that leverages technical, fundamental and quantitative analysis, also known as quantamental analysis.  Most of our strategies are also hedged to reduce downside exposure. Our team actively manages four long/short stock strategies, a non-directional income generating options-based strategy, and a leverage dividend income fund.</span></h5><br>
							<h5 style="font-size: 20px"><span></span></h5>
													</div>
					
					</div>
				</div>
			</div> <!-- /.intro-text-block --><br>


			<!-- Element Style -->
			<div class="element-section mb-50 md-mb-100">
				<div class="container">
					<div class="row">
							...
							<div id='theme-tab-three' class="theme-tab-basic theme-tab" data-role='z-tabs' data-options='{"theme": "silver", "orientation": "vertical", "animation": {"duration": 400, "effects": "slideV"}}'>
					            ...
					            <div class="tab-container">
					                ...
					                <div>
					                    ...
					                    <ul class="list-item">
											<li> Capital preservation is a top priority – We follow strict exit rules that allow the winners to run, but able to exit positions fast enough to lock in gains and preserve capital during periods of high volatility.</li>
											<li>We maintain specialized options-based hedges in our portfolios at a very low cost, which reduces drawdown during market corrections.</li>
											
											<li> Our portfolio managers are trained as traders, so we are nimble, fast moving and follow our entry and exit rules decisively.</li>
											<li>We leverage sophisticated analysis that blends technical, fundamental and factor-based quantitative analysis, also known as quantamental analysis.</li>
